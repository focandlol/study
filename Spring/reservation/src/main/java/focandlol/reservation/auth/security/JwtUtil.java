package focandlol.reservation.auth.security;

import focandlol.reservation.global.exception.CustomException;
import focandlol.reservation.auth.dto.CustomUserDetails;
import focandlol.reservation.auth.service.CustomerUserDetailsService;
import focandlol.reservation.auth.service.ManagerUserDetailsService;
...
public class JwtUtil {
    ...
    private JwtUtil(@Value("${spring.jwt.secret}") String secret,
                    ...
                    CustomerUserDetailsService userDetailsService, ManagerUserDetailsService managerUserDetailsService) {
