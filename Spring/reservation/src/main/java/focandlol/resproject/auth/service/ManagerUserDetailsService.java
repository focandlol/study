...
import static focandlol.resproject.global.exception.ErrorCode.MANAGER_NOT_FOUND;

/**
 * Manager 인증 요청을 처리하기 위한 UserDetailsService 구현체
 * - username을 기준으로 ManagerRepository 사용자 정보를 조회
...
public class ManagerUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ManagerEntity customer = managerRepository.findByUsername(username)
